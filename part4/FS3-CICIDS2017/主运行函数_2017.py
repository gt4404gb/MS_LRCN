...
from LRCCNpretrain_2017 import pretrain_model, pretrain_simclr, pretrain_Transformermodel, pretrain_VAE, create_model
...
Config.PRETRAIN_LR = 0.001
Config.PRETRAIN_EPOCHS = 100
Config.PRETRAIN_MASK_RATIO = 0.1
...
#[8]
# 加载已保存的模型
model_path = "contrastive_encoder_f1_0_9121.pth"  # 可修改为其他路径
